 ...
 * @author Eibe Frank
 */
public class ClassBalancedPlus extends RandomizableSingleClassifierEnhancer
  ...
  /** The first successor */
  protected ClassBalancedPlus m_FirstSuccessor = null;

  /** The second successor */
  protected ClassBalancedPlus m_SecondSuccessor = null;
 ...
 if(initial){
     String[] indicesString = new String[indices.length];
     for(int i = 0; i<indices.length; i++){
         indicesString[i] = classNames[indices[i]];
     } 
   
     stringbuffer.append(Arrays.toString(indicesString));
     out.println();
  ...
  public String toString() {
    ...
    if (m_classifiers == null) {
      return "ClassBalancedPlus: No model built yet.";
    }
    StringBuffer text = new StringBuffer();
    text.append("ClassBalancedPlus");
    treeToString(text, 0);

...
public class ClassBalancedND extends RandomizableSingleClassifierEnhancer
  ...
  private void generateClassifierForNode(Instances data, Range classes,
   ...
   // System.out.println(Arrays.toString(firstInds));
   // System.out.println(Arrays.toString(secondInds));
  ...
  public static void main(String[] argv) {
    ClassBalancedND classBalancedND = new ClassBalancedND();
    
    runClassifier(classBalancedND, argv);
  }
}

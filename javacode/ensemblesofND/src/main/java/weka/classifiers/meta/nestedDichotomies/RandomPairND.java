...
public class RandomPairND extends RandomizableSingleClassifierEnhancer implements TechnicalInformationHandler {
  ...
  public static void main(String[] argv) throws FileNotFoundException {
    /*  String[] arg = new String[5];
      arg[0] = "-t"; //training
      arg[1] = "/Users/katie/NetBeansProjects/weka/trunk/packages/internal/ensemblesOfNestedDichotomies/out/randomPair/pageBlocks/NDfold1.arff";
      arg[2] = "-T";
      arg[3] = "/Users/katie/NetBeansProjects/weka/trunk/packages/internal/ensemblesOfNestedDichotomies/out/randomPair/pageBlocks/NDtest1.arff";
      arg[4] = "-k";
      PrintStream out = new PrintStream(new FileOutputStream("outputNDRandomPair.txt"));
        System.setOut(out);*/

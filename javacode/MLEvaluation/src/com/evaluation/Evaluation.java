 ...
 * Evaluator based on predefined rules.
 *
 *
 * @author Jozef Vilcek
 */
public class Evaluation {
    ...
    public void setLabelBasedMeasures(LabelBasedMeasures labelBasedMeasures) {
    ...
    public void setExampleBasedMeasures(ExampleBasedMeasures exampleBasedMeasures) {
    ...
    public void setRankingBasedMeasures(RankingBasedMeasures rankingBasedMeasures) {
        this.rankingBasedMeasures = rankingBasedMeasures;
    }

    public void setConfidenceLabelBasedMeasures(ConfidenceLabelBasedMeasures confidenceLabelBasedMeasures) {
...
//            for(int i = 0; i < 22; ++i) {
//                description += "Vk: " + (labelBasedMeasures.truePositives[i] + labelBasedMeasures.falseNegatives[i]) + " ";
//                description += "TP: " + labelBasedMeasures.truePositives[i] + " ";
//                description += "FN: " + labelBasedMeasures.falseNegatives[i] + " ";
//                description += "FP: " + labelBasedMeasures.falsePositives[i] + " ";
//                description += "TN: " + labelBasedMeasures.trueNegatives[i] + "\n";
//                
//            }

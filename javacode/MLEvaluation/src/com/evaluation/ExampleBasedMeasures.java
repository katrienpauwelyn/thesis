...
public double averagePredicted;	
	...
	public ExampleBasedMeasures(MultiLabelOutput[] output, boolean[][] trueLabels, double forgivenessRate) {
        this.forgivenessRate = forgivenessRate;
        computeMeasures(output, trueLabels);
	}
	
	public ExampleBasedMeasures(MultiLabelOutput[] output, boolean[][] trueLabels) {
        ...
        for (int instanceIndex=0; instanceIndex<numInstances; instanceIndex++)
		{
			...
			else
			{
				...
				if (labelActual > 0)    recall += (setIntersection / labelActual);
                        ...
                        averagePredicted += labelPredicted;
			hammingLoss += (symmetricDifference / numLabels);
		}
        averagePredicted/=numInstances;
